...
<html>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
            <a href="../index.php" class="logo" style="background:url('<?= $path.$img?>'); background-size:230px 100px; background-repeat: no-repeat; background-position: center;  background-color: rgba(97, 41, 95, 0.32); border-color: #361563;"></a>
