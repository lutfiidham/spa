    ...
    <body margin-left="0" margin-top="0">
      <div class="header_fixed">
        <div class="morph-button morph-button-modal morph-button-modal-3 morph-button-fixed">
          <button class="blue_color_button" type="button" onclick="popmodal_add_ruangan()">ADD ROOM</button>
        </div><!-- morph-button -->
        <div class="morph-button morph-button-modal morph-button-modal-3 morph-button-fixed">
...
<script type="text/javascript">
  ...
  function popmodal_add_ruangan(){
    $('#medium_modal').modal();
    var url = 'infrastruktur_setting.php?page=popmodal_add_ruangan';
      $('#medium_modal_content').load(url,function(result){});
  }
