...
function same_select_ruangan($i_name, $i_branch_id)
{
	$query = mysql_query("SELECT * FROM ruangan WHERE ruangan_name='$i_name' AND branch_id='$i_branch_id'");
	$qresult = mysql_num_rows($query);
	return $qresult;
}
