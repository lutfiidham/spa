...
include '../models/report_terapis_model.php';
$page = null;
$page = (isset($_GET['page'])) ? $_GET['page'] : "list";
$title = ucfirst("Report Terapis");
...
switch ($page) {
	...
	case 'list':
		...
		$action = "report_terapis.php?page=form_result&preview=1";

		include '../views/report_pemijat/form.php';
		...
		if(isset($_GET['preview'])){
			...
			include '../views/report_terapis/form_result.php';
			include '../views/report_terapis/list_item.php';
			//include '../views/report_detail/list_partner.php';
			include '../views/report_terapis/list_transaction.php';
		}
	...
	case 'form_result':
		...
		header("Location: report_terapis.php?page=list&preview=1&date=$date_default&terapis=$terapis");
	break;
